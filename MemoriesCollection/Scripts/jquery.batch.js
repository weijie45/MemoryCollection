...
if (typeof(jQuery) == 'function') {
    (function($){
        ...
        var methods = 'attr offset position scrollTop scrollLeft innerWidth innerHeight innerHTML outerWidth outerHeight outerHTML width height html text val data'.split(' ');
